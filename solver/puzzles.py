...
# All puzzle configurations (15x20 grids, 8-11 mirrors)
# First 7 puzzles (indices 0-6) are ALREADY USED for Jan 22-28, 2026
# New puzzles (indices 7+) are available for Jan 29 onwards
PUZZLES = [
    PuzzleConfig(
        name="Spiral Inward",
        width=GRID_WIDTH,
    ...
    # New puzzles for extended date range
    PuzzleConfig(
        name="Cross Roads",
        width=GRID_WIDTH,
        height=GRID_HEIGHT,
